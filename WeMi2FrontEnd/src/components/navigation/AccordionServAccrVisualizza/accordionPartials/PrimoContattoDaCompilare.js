...
const PrimoContattoDaCompilare = ({
  ...
  if (DatiLogin && DatiLogin.Ruolo === "Amministratore WeMi") {
  ...
  readonly="true"
            ...
            <Row padding="0" division={12}>
              <Column xs={12}>
                ...
                <Calendario 
               getValue={()=>{}}
                 ValoriDaAttivare={EstraiDettaglioAmministrativoServizioEnte.EstraiDettaglioAmministrativoServizioEnte.ente.datiEnte.js_primo_contatto?
...
PrimoContattoDaCompilare.displayName = 'PrimoContattoDaCompilare';

export default connect(
  mapStoreToProps
)(withAuthentication(PrimoContattoDaCompilare));
