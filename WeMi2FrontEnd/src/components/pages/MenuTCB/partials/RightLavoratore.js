...
const RightLavoratore = () => (
  <>
    <Row margin="0 0 1em" justifycontent="space-between">
      ...
      <Column md="3" flex alignitems="center" padding="0">
        <Button  value="Candidati" color="red" />
      </Column>
    </Row>
...
Configura in pochi passaggi secondo le tue esigenze puoi salvare le tue personalizzazioni. Puoi condividere i tuoi acquisti con altre persone ed ottenere prezzi più convenienti."
      ...
      <Column md="3" flex alignitems="center" padding="0">
        <Button  value="Modifica disponibilità" color="red" />
      </Column>
    </Row>
    ...
    <Row margin="0 0 1em" justifycontent="space-between">
      ...
      <Column md="3" flex alignitems="center" padding="0">
        <Button  value="Vedi opportunità" color="red" />
      </Column>
    </Row>
  </>
);

RightLavoratore.displayName = 'RightLavoratore';

export default RightLavoratore;
