...
const Servizi = ({
  ...
  const BreadcrumbPathEnte = [
...

    {
      ...
      url: `GestioneEnte/${id_ente}/SchedaServiziEnte`,
    },
  ];
  ...
  return (
    <Wrapper>
      <Breadcrumbs value="Breadcrumb.page" pathSlashes={BreadcrumbPathEnte} />
      ...
      <Row fluid margin="2em 0">
        <Column xs={12} padding="0">
          <AggiungiServizio Callback={() => { setOpenModal(true); }}></AggiungiServizio>
        </Column>
        <Column xs={12} padding="0">
          <Filtri
            State={{ filtri,
...
export default connect(
    mapStateToProps,
    mapDispatchToProps
)(withAuthentication(withRouter(Servizi)));
