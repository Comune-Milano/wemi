...
export const insertSttForJsImpersonificazione = `
INSERT INTO wemi2.richiesta_servizio_ente_stt(
  ...
  VALUES ($[idRichiestaTCB], localtimestamp, 10, 0, $[id_utente]);
INSERT INTO wemi2.richiesta_servizio_base_stt(
   ...
   VALUES ($[id_richiesta_servizio_base], localtimestamp, 5, $[id_utente]); 
