...
import { verificaUtente } from "../../sql/servizioerogatoente/verificautente";
 ...
 */
export class ServiziErogatiValidator extends Validator {
    /**
    ...
    constructor(keysToArgs, argomenti) {
        ...
        this.servizioErogatoEnte = super.findArgs();
    }
    /**
     * 
    ...
    async validate(user) {
        try {
             ...
             */
            const risultato = await db.one(verificaUtente, { idUtente: user.idUtente, servizioErogatoEnte: this.servizioErogatoEnte });
            return risultato;
        }
        catch (error) {
            throw (ACCESS_DENIED);
